...
function InformationCard({ item }) {
    return (
        <li className='p-4 w-[700px] bg-slate-200 rounded-lg'  >
            ...
            <div className='flex items-center border-b-[1px] border-b-gray-400 py-4 justify-between'>
                <span className='text-lg font-bold'>Hobby or Study:</span>
            ...
            <div className='flex items-center py-4 justify-between'>
                ...
                <div className='flex items-center space-x-8 '>
                    ...
                    <DeleteOutlined className='scale-125 hover:scale-[1.5] duration-300 p-1 hover:text-red-500 hover:bg-[#00000011] rounded-full' />
                    <EditOutlined className='scale-125 hover:scale-[1.5] duration-300 hover:!text-blue-500 p-1 hover:bg-[#00000011] rounded-full' />
                </div>
            </div>
